...
from reward_worker.infer_fns import (
...
class RMRemoteCaller(RewardModelCallingFunction):
    ...
    def __call__(
        ...
        return _reward_inference_fastchat(
            input_str=input_str, model_name=self.model_name, controller_addr=self.controller_addr, timeout=timeout, multi_gpu=self.multi_gpu
        )
